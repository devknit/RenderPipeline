Shader "Hidden/RenderPipeline/Antialiasing/FXAA Preset 3"
{
	CGINCLUDE
	...
	/*============================================================================
									VERTEX SHADER
	============================================================================*/
	float2 FxaaVertexShader( float2 inPos) // Both x and y range {-1.0 to 1.0 across screen}.
	{
		return (inPos.xy * FxaaFloat2( 0.5, 0.5)) + FxaaFloat2( 0.5, 0.5);
	}  
	...
	Fallback "Hidden/Zan/PostProcessing/Antialiasing/FXAA2"
}
